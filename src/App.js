...
import ScheduleTour from './Layouts/ScheduleTour';
...
function App() {
	return (
	  <React.Fragment>
		...
		<QuickFacts/>
		<Overview 
		  imageUrl='https://firebasestorage.googleapis.com/v0/b/ally-health-obgyn.appspot.com/o/minimalistic-kitchen.png?alt=media&token=7ade0edd-cdf7-4832-957c-6636890f6874'
		  backgroundColor='var(--tanBackgroundColor)'
		/>
		<ScheduleTour/>
	  </React.Fragment>
	);
